...
const SearchSection = (props : SearchResultsSectionPropsType) => {
        ...
        <div className='product-section'>
          {
            ...
            [...displayData].map((element, index) => (element.setDisplayActive) ? <ProductCard key={index} product={element}/> : null)
          }
        </div>
      </div>
    </div>
